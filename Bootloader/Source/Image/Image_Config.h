...
#define METADATA_ROLLBACK_SLOT_OFFSET 0x0011U

#define METADATA_PENDING_SLOT_OFFSET 0x0012U

#define METADATA_BOOT_STATE_OFFSET 0x0013U

#define METADATA_BOOT_ATTEMPTS_OFFSET 0x0014U

#define METADATA_MAX_BOOT_ATTEMPTS 3U
 ...
 *
 * The request is placed in Flash sector 3 so applications can
 * erase/write it
