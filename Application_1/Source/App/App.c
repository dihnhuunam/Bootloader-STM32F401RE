/**
 * @file App.c
 * @brief Application runtime, boot confirmation, and OTA polling loop.
 */
#include "App.h"
#include "Debug.h"
#include "Flash.h"
...
static void App_Confirm_Boot(void)
{
    ...
    {
        Debug(DEBUG_LOG_PREFIX "Application 1 boot confirmed\n");
    }
}
...
void App_Start()
{
    ...
    while (1)
    {
        ...
        Led_Blink(3000);
        Debug(DEBUG_LOG_PREFIX "Application Firmware 1 v%lu.%lu.%lu\n", (unsigned long)version_major, (unsigned long)version_minor,
